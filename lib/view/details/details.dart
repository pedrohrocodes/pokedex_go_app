...
class Details extends StatelessWidget {
  ...
  const Details({Key key, this.poke}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(poke.name, style: TextStyle(fontWeight: FontWeight.w600)),
      ),
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Hero(
                tag: poke.id,
                child: Image.network(img, fit: BoxFit.cover, height: 150),
              ),
            ),
            SizedBox(height: 20),
            Text(poke.name,
